...
public class sport_recycler_record_adapter extends RecyclerView.Adapter<sport_recycler_record_adapter.Viewholder> {
    ...
    Context context;
    public static List<String> sport_record_name = new ArrayList<>();
    public static List<String> sport_record_info = new ArrayList<>();
    ...
    //初始化其他紀錄
    public static void initView_record_other() {
    ...
    public void initStartTimePicker(final int position) {
        ...
        mTimePickerView.setOnTimeSelectListener(new TimePickerView.OnTimeSelectListener() {
            ...
            public void onTimeSelect(Date date) {
                ...
                Sport_Plus_Activity.sport_recycler_record_adapter.sport_record_info.set(position,format.format(date));
                Sport_Plus_Activity.sport_recycler_record_adapter.notifyDataSetChanged();
            }
        });
...
//                count_cal.if_else_sport(Sport_Plus_Activity.tv_sport_child_name.getText().toString(),total_time,40);
                Sport_Plus_Activity.sport_recycler_record_adapter.sport_record_info.set(position,String.valueOf(total_time) + "分");
                Sport_Plus_Activity.sport_recycler_record_adapter.notifyDataSetChanged();
            }
        });
        mTimePickerView.show();
