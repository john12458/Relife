...
import com.mis.relife.pages.Service.FloatWindowBigView;
import com.mis.relife.pages.Service.FloatWindowSmallView;
    ...
    public static void createSmallWindow(Context context) {
        ...
        if (smallWindow == null) {
            ...
            if (smallWindowParams == null) {
                ...
                smallWindowParams.y = screenHeight / 3;
            }
...
//                bigWindowParams.gravity = Gravity.TOP | Gravity.TOP;
